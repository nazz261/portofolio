...
export default function Footer({ 
    ...
    return (
        <footer className={`mt-auto border-t border-slate-200/80 dark:border-slate-800/80 ${className}`}>
            <div className="mx-auto max-w-5xl px-5 py-10 text-center">
                ...
                <p className="text-base text-slate-500 dark:text-slate-400">{copyright}</p>
            </div>
        </footer>
    );
}
